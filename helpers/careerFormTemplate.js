                ...
                <tr>
                  ...
                  >
                    ...
                    <ul style="padding: 0; margin: 0; list-style-type: disc">
                      ...
                      >${data.resume}</a>`}</li>` : ''}
                      ${!data.resume ? `<li style="margin: 0 0 10px 30px">CV: No attachment and might sent directly to hr@ac-re.com.tw.</li>` : ''}
                      ...
                      ${!data.coverLetter ? `<li style="margin: 0 0 10px 30px">Cover letter: No attachment and might sent directly to hr@ac-re.com.tw.</li>` : ''}
                    </ul>
                  </td>
                </tr>
                <!-- Rich Text : END -->
