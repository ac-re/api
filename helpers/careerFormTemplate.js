                ...
                <tr>
                  ...
                  >
                    ...
                    <ul style="padding: 0; margin: 0; list-style-type: disc">
                      ...
                      >${data.resume}</a>`}</li>` : ''}
                      ${!data.resume ? `<li style="margin: 0 0 10px 30px">CV: No attachment might due to the oversize and sent to the email: hr@ac-re.com.tw.</li>` : ''}
                      ...
                      ${!data.coverLetter ? `<li style="margin: 0 0 10px 30px">Cover letter: No attachment might due to the oversize and sent to the email: hr@ac-re.com.tw.</li>` : ''}
                    </ul>
                  </td>
                </tr>
                <!-- Rich Text : END -->
