  ...
  >
    ...
    <![endif]-->
      ...
      <div
        ...
        "
      >
        ${email.title} ${email.name} apply for the position ${email.role}. Attached with CV/cover letter.
      </div>
                ...
                <tr>
                  ...
                  >
                    ...
                    <ul style="padding: 0; margin: 0; list-style-type: disc">
                      <li style="margin: 0 0 10px 30px">Title*: ${email.title}</li>
                      <li style="margin: 0 0 10px 30px">Name*: ${email.name}</li>
                      <li style="margin: 0 0 10px 30px">Phone*: ${email.mobile}</li>
                      <li style="margin: 0 0 10px 30px">Email*: ${email.email}</li>
                      <li style="margin: 0 0 10px 30px">Type of role you’d like to apply: ${email.role}</li>
